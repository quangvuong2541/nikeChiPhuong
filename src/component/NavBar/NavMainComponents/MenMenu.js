...
function MenMenu() {
    ...
    React.useEffect(() => {
        // console.log(Params);
        if (useLocations === "/men") {
            console.log("truonog quang vuong ddepj trai");
    ...
    const closeMen = () => {
        let underLine = document.getElementById("men");
        ReactDOM.findDOMNode(underLine).style.borderBottom = "none"
        let container = document.getElementById("menContainer");
    ...
    return (
        ...
        >
            ...
            <Link to="/men" id="men" className={classes.mainMenuChoiceLink}>Men</Link>
